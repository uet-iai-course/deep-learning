...
| L05-33 | 4 | Hình thức | Vectơ hóa tensor; $I+J_F$, $J_P+J_F$, tích Jacobian chuyển vị–vectơ $\bar x=J_s^\top\bar s$; nhắc quy ước gradient cột và tiên quyết Jacobian Bài 02–03 | $J_F,J_P\in\mathbb R^{d_{out}\times d_{in}}$; trường hợp hậu kích hoạt đưa xuống ghi chú | suy ra; `lec09` 29 |

...
| L05-20 | 3 | Tính toán | 163.328 so với 393.216 trọng số; MAC tích chập bằng $HW|W|$ | cùng $H,W$ và kênh ra | tính lại |
...
| L05-26 | 3 | Trực giác kích thước | Minh họa ba trục giảm và phát rộng theo kênh | $1×64×1×1$ | GT 155–156 |
...
| L05-33 | 4 | Hình thức | Vectơ hóa tensor; $I+J_F$, $J_P+J_F$, tích Jacobian chuyển vị–vectơ $\bar x=J_s^\top\bar s$ | $J_F,J_P\in\mathbb R^{d_{out}\times d_{in}}$ | suy ra; `lec09` 29 |
...
| L05-36 | 2 | Triển khai/kiểm tra | ResNet-18: phần gốc → bốn giai đoạn 2–2–2–2 → gộp toàn cục | chờ 20 giây; chiếu ở giai đoạn 2–4 | `lec09` 31; GT 161–163 |
...
| L05-X05 | 4 | Vectơ đặc trưng nối sang mô tả ảnh | Cầu nối trừu tượng sang Bài 07 | `lec09` 45 |
...
| GoogLeNet/Inception | Vấn đề L05-16 → trực giác L05-18 → ví dụ L05-17–18 → hình thức L05-19 → tính L05-20,22 → triển khai L05-21 → kiểm tra L05-23 | phần gốc + một khối → dấu vết đủ 9 khối và đầu phân loại | $192×28^2$, 64/128/32/32, 2–5–2 | Ví dụ phần gốc đứng trước khối để cung cấp $C_{in}=192$; L05-21 thay bảng nhánh lặp | “Mạng nhiều tầng tiếp theo cần phân biệt thống kê huấn luyện và suy luận.” | 20 phút; xuống L05-16→23, chờ 30 giây ở L05-23, phải ở cuối cụm |
| Chuẩn hóa theo lô | Vấn đề L05-24 → ví dụ và hình thức L05-25 → trực giác kích thước L05-26 → triển khai L05-27 → kiểm tra L05-28 | $X:NCHW$ → 6272 giá trị/kênh → công thức → hai chế độ | $8×64×28×28$, 6272, $1×64×1×1$ | Ví dụ số đứng trước công thức ngay trên L05-25; L05-26 trực quan hóa trục và phát rộng | “Chuẩn hóa kiểm soát thang kích hoạt; ResNet thêm đường truyền trực tiếp.” | 14 phút; xuống L05-24→28, phải ở L05-28 |
...
| Học chuyển giao | Vấn đề/ví dụ L05-37 → trực giác/hình thức/triển khai gộp L05-37 → kiểm tra L05-37–38 | tập mới nhỏ, gần miền nguồn → cấu hình thân/đầu và BN | gradient; huấn luyện/suy luận | Không có phép tính số trong nguồn; gộp chu trình trên một trang để giữ vai trò cầu nối ngắn | Kết thúc bằng bảng kiểm bốn trục | 5 phút; xuống L05-37→38, phải ở L05-38 |

Điều hướng lõi: trong mỗi cụm, nhấn xuống để đi qua các trang; tại trang cuối cụm, nhấn phải để sang trang đầu cụm kế tiếp. Dừng tại L05-38 nếu cắt tuyến mở rộng. Nếu tiếp tục, nhấn phải sang L05-X01 rồi nhấn xuống lần lượt L05-X02–L05-X05; không đi xuống từ L05-38.

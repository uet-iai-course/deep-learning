...
| Trường tiếp nhận | Vấn đề L04-33 → trực giác L04-34 → ví dụ L04-35 → hình thức L04-36 → triển khai L04-37 → kiểm tra L04-36 | Tầng tham chiếu → truy hồi $r,j$ và thân mạng nhiều tầng | $r_0=j_0=1$, $(K,S)$, chuỗi 3→5→7 | Kiểm tra gộp với hình thức ở L04-36 vì câu hỏi giải thích đúng hạng $(K_l-1)j_{l-1}$ | “Dùng kích thước, chi phí và trường tiếp nhận để kiểm tra toàn tầng.” | 12 phút; đi ngang L04-33→37; tại L04-37 chọn End tới kết luận hoặc nhấn phải sang mở rộng |

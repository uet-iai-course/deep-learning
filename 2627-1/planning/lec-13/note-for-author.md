...
- L13-35–38 đọc cùng một hàng: $(s_1,phải,0,s_2,0,0)$ → $q=.4$ → $Y=.9$ → hạng tử bình phương $.25$; đóng góp vào trung bình là $.25/B$ nếu $B>1$.
- L13-39 là pha thu thập, không backward. L13-40 là pha cập nhật; optimizer chỉ chứa $\theta$. Reset môi trường khi terminal hoặc truncated, nhưng target chỉ triệt bootstrap khi terminal.
- Nói rõ DQN phi tuyến không có bảo đảm hội tụ tổng quát.

## Điều hướng và cắt

- Lõi 100 phút: đi xuống L13-00→12, đi phải; đi xuống L13-13→25→27→26, đi phải; đi xuống L13-28→41 và dừng. L13-27 là trang áp chót của stack thứ hai dù ID lớn hơn L13-26.
- Phụ lục 20 phút: chỉ từ L13-41 đi phải sang X01, rồi đi xuống X02→X04.
...
- L13-20: bật $D^{trunc}$ và giữ giá trị tương lai nếu $S'$ hợp lệ.
...
- X02: dùng $R_{100}+\gamma\max_aQ(S_{100},a)$ khi $S_{100}$ hợp lệ.
- X03: học ngoài chính sách không thay điều kiện độ phủ.
- X04: $Q_{all}:32\times4$; chỉ số $32\times1$; $q,Y$ có 32 phần tử; mất mát vô hướng.
...
4. 15 phút: tính $G_t$, đích Bellman và cập nhật Q; dùng một mẫu terminal và một mẫu truncated.
